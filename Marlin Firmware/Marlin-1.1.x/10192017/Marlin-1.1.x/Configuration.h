...
#define STRING_CONFIG_H_AUTHOR "Steve 10/17/2017" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION "Ze DoppelGanger"// will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 WEBSITE_URL "Beta 11052017.4"   // will be shown during bootup in line 2
